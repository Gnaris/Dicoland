...
<div id="share-buttons">
    ...
    <a href="mailto:?Subject=Dicoland.com&amp;Body=La%20maison%20du%20dictionnaire%20et%20MediQualis%20!%20 http://www.dicoland.com" style="text-decoration:none">
        <img src="{$urlsite}fr/img/mail-icone.png" alt="Email">
    </a>
 
    <!-- Facebook -->
    <a href="http://www.facebook.com/sharer.php?u={$urisite}" target="_blank" style="text-decoration:none">
        <img src="{$urlsite}fr/img/facebook-icone.png" alt="Facebook">
    </a>
    
    <!-- LinkedIn -->
    <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={$urisite}" target="_blank" style="text-decoration:none">
        <img src="{$urlsite}fr/img/linkedin-icone.png" alt="LinkedIn">
    </a>
     
    <!-- Twitter -->
    <a href="https://twitter.com/share?url={$urisite}&amp;name=Dicoland.com&amp;hashtags=dicoland" target="_blank" style="text-decoration:none">
        <img src="{$urlsite}fr/img/twitter-icone.png" alt="Twitter">
    </a>
</div>
...
myaccount.tpl					{include file="$applicationlang/aide_commande.tpl"}
			...
			<div class="center">
				<div id='innercenter'>
				{if !$smarty.get.page}
                       		 {include file="$applicationlang/covidv3.tpl"}
