<?php /* Smarty version 2.6.31, created on 2020-10-15 11:25:00
         compiled from de/formlivraison.tpl */ ?>
...
verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Diese Adresse benutzen" src="<?php echo $this->_tpl_vars['urlsite']; ?>
...
verifformlivraison.php">
    ...
    <input type="image" name="livraison_submit" value="Eine andere Adresse benutzen" src="<?php echo $this->_tpl_vars['urlsite']; ?>
lang/<?php echo $this->_tpl_vars['applicationlang']; ?>
