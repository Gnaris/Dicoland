<?php /* Smarty version 2.6.31, created on 2020-12-02 17:12:36
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['showproduct']['categorie'])) ? $this->_run_mod_handler('utf8_encode', true, $_tmp) : utf8_encode($_tmp)); ?>
						...
						<?php endif; ?>
						<?php if ($this->_tpl_vars['showproduct']['isbn']): ?>
							<li><strong>ISBN : </strong><?php echo $this->_tpl_vars['showproduct']['isbn']; ?>
</li>
						<?php endif; ?>
					</ul>
				</td>
