<?php /* Smarty version 2.6.31, created on 2021-05-05 19:00:00
         compiled from es/detailcommande.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'es/detailcommande.tpl', 10, false),array('modifier', 'utf8_encode', 'es/detailcommande.tpl', 15, false),)), $this); ?>
<div id="detailcommande">
<h2><span class="deco">></span>Referencia pedido<?php echo $_GET['no']; ?>
</h2>
...
<em>
      ...
      <?php if ($this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite'] > 1): ?>
        <br /><em>(Pedido de <?php echo $this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite']; ?>
 ejemplares)</em>
  		<?php endif; ?>
  		</div>
  		<hr />
...
<a href='<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=oldcommande'>Consultar la lista de los pedidos anteriores</a>
</div>