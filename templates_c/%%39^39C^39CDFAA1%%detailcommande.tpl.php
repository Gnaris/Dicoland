<?php /* Smarty version 2.6.31, created on 2020-05-22 14:21:28
         compiled from it/detailcommande.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'it/detailcommande.tpl', 10, false),array('modifier', 'utf8_encode', 'it/detailcommande.tpl', 15, false),)), $this); ?>
<div id="detailcommande">
<h2><span class="deco">></span>Ordine numero <?php echo $_GET['no']; ?>
</h2>
...
<em>
      ...
      <?php if ($this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite'] > 1): ?>
        <br /><em>(ordinato in <?php echo $this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite']; ?>
 esemplari)</em>
  		<?php endif; ?>
  		</div>
  		<hr />
...
<a href='<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=oldcommande'>Visualizza l'elenco dei tuoi ordini precedenti</a>
</div>