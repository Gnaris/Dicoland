<?php /* Smarty version 2.6.31, created on 2020-07-17 09:14:06
         compiled from en/detailcommande.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'product_link', 'en/detailcommande.tpl', 10, false),array('modifier', 'utf8_encode', 'en/detailcommande.tpl', 15, false),)), $this); ?>
<div id="detailcommande">
<h2><span class="deco">></span>Order reference <?php echo $_GET['no']; ?>
</h2>
...
<em>
      ...
      <?php if ($this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite'] > 1): ?>
        <br /><em>(<?php echo $this->_tpl_vars['produit'][$this->_sections['produit']['index']]['quantite']; ?>
 copies ordered)</em>
  		<?php endif; ?>
  		</div>
  		<hr />
...
<a href='<?php echo $this->_tpl_vars['urlsite']; ?>
index.php?page=oldcommande'>View the list of your old orders</a>
</div>